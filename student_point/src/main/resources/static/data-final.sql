...
--
-- Table structure for table `schedule_of_students`
--

DROP TABLE IF EXISTS `schedule_of_students`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `schedule_of_students` (
                                        `id` varchar(255) NOT NULL,
                                        `schedule_id` varchar(255) DEFAULT NULL,
                                        `student_id` varchar(255) DEFAULT NULL,
                                        PRIMARY KEY (`id`),
                                        KEY `FKkrq4wkhqeiosp8obph2uqxk3a` (`schedule_id`),
                                        KEY `FKgdxuc4rkeih39th12ym6j09jh` (`student_id`),
                                        CONSTRAINT `FKgdxuc4rkeih39th12ym6j09jh` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`),
                                        CONSTRAINT `FKkrq4wkhqeiosp8obph2uqxk3a` FOREIGN KEY (`schedule_id`) REFERENCES `schedules` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `schedule_of_students`
--

LOCK TABLES `schedule_of_students` WRITE;
/*!40000 ALTER TABLE `schedule_of_students` DISABLE KEYS */;
/*!40000 ALTER TABLE `schedule_of_students` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `schedules` (
                             `id` varchar(255) NOT NULL,
                             `email_lecture` varchar(255) DEFAULT NULL,
                             ...
                             PRIMARY KEY (`id`),
                             KEY `FK9orahp5in2a2xyhl3ks1xyilj` (`subject_id`),
                             CONSTRAINT `FK9orahp5in2a2xyhl3ks1xyilj` FOREIGN KEY (`subject_id`) REFERENCES `subjects` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `semester_of_students` (
                                        ...
                                        `exemptions` float DEFAULT NULL,
                                        `owed` float DEFAULT NULL,
                                        `receivable` float DEFAULT NULL,
                                        `root_tuition` float DEFAULT NULL,
                                        PRIMARY KEY (`id`),
...
INSERT INTO `semester_of_students` VALUES ('10836b07-618e-42a7-9aa4-ab76263da6d0',3.225,'324475b9-6e53-4f0e-b62a-7a67541c0bec','2ed695d0-fbe0-47c7-b3f1-4917e3ce6496',9600000,0,0,9600000,9600000),('11fbe5aa-0157-485d-adff-64f25abd1a1e',2.8375,'9da3175a-c1a0-4b72-a812-cf058b19ca62','2ed695d0-fbe0-47c7-b3f1-4917e3ce6496',7680000,0,0,7680000,7680000),('23ec7278-ce72-42a9-810c-ed3707dd9d51',3.2,'326f3844-05a0-4e36-b935-e41344de0928','2ed695d0-fbe0-47c7-b3f1-4917e3ce6496',12000000,0,0,12000000,12000000),('635ac152-d523-430c-8d01-23ac074e6734',3.4166666666666665,'a75f647e-7151-40fb-8732-f22aedbc599e','2ed695d0-fbe0-47c7-b3f1-4917e3ce6496',8640000,0,0,8640000,8640000),('89606dc8-0503-4b30-80c5-3952d5361a0f',3,'87367bec-a597-41a6-aaf5-7f320ebfc2a7','2ed695d0-fbe0-47c7-b3f1-4917e3ce6496',2400000,0,0,2400000,2400000),('9276ffc1-bed7-4c0a-a6ee-9af10bd40a5a',3.0300000000000002,'62d73a4f-6177-4c5c-9f3a-82341ee9a074','2ed695d0-fbe0-47c7-b3f1-4917e3ce6496',9600000,0,0,9600000,9600000),('d260e7a9-115a-4879-8a57-fad9ca378a80',3.225925925925926,'e1fbf3d9-28d1-4ab6-baf7-b5a8f2a94c39','2ed695d0-fbe0-47c7-b3f1-4917e3ce6496',12960000,0,0,12960000,12960000),('e36b593e-7c26-4dec-bfde-57cf07ddae3d',3.2705882352941176,'27bb76d1-41df-4198-b5e4-42d592560de3','2ed695d0-fbe0-47c7-b3f1-4917e3ce6496',8160000,0,0,8160000,8160000);
...
--
-- Dumping routines for database 'student_point_db'
--
...
-- Dump completed on 2023-08-05 23:51:45
