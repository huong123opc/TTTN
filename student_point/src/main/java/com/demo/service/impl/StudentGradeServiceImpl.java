...
public class StudentGradeServiceImpl implements StudentGradeService {
    ...
    public BaseResponse updateGradeForStudent(StudentGradeReq studentGradeReq) {
        ...
        Semester semester = semesterRepository.findByName(studentGradeReq.getSemesterName())
                .orElseThrow(() -> new BaseErrorException(
                        "Semester not found with name: " + studentGradeReq.getSemesterName(), null
                ));
        SemesterOfStudent semesterOfStudent = semesterOfStudentRepository
                .findByStudent_StudentCodeAndSemester_Name(studentGradeReq.getStudentCode(), studentGradeReq.getSemesterName())
